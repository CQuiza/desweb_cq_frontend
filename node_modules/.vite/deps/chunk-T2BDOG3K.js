...
import {
  Control_default,
  init_Control
} from "./chunk-NGAHDLPN.js";
import {
  MapEventType_default,
  init_MapEventType
} from "./chunk-3ORYLTNB.js";
import {
  GroupEvent,
  Group_default,
  init_Group
...
var Map = class extends Object_default {
  ...
  renderFrame_(time) {
    ...
    this.renderComplete_ = this.hasListener(MapEventType_default.LOADSTART) || this.hasListener(MapEventType_default.LOADEND) || this.hasListener(EventType_default3.RENDERCOMPLETE) ? !this.tileQueue_.getTilesLoading() && !this.tileQueue_.getCount() && !this.getLoadingOrNotReady() : void 0;
...
//# sourceMappingURL=chunk-T2BDOG3K.js.map
